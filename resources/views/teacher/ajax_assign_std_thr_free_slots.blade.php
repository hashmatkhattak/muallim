    ...
    <tr style="padding: 1px">
        ...
        @foreach($week_days as $key=>$slots)
            <td style="padding-left:0px">
                <ul style="width: 145px;margin: 0 !important;padding: 0 !important;">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-12">
        <div class="form-group cu-btn-category">
            <button  type="button" class="btn btn-primary btn-theme1 add_student_to_teacher_schedule">Add</button>
        </div>
    </div>
</div>
