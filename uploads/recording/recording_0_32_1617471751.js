...
class Codec8E extends Codec {
    ...
    parseIoElements() {
        try {
             ...
             */
            let ioCountInt8 = this.reader.ReadInt16();
            for (var i = 0; i < ioCountInt8; i++) {
                let property_id = this.reader.ReadInt16();
             ...
             */
            let ioCountInt16 = this.reader.ReadInt16()
             ...
             */
            let ioCountInt32 = this.reader.ReadInt16();
             ...
             */
            let ioCountInt64 = this.reader.ReadInt16();
