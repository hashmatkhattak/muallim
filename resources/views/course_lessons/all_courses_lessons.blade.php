        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    Lessons
                    <a class="btn btn-primary pull-right pasiingset btn-theme1" href="{{ route('add_lesson',['cid'=>$course_id]) }}">
                            ...
                            @foreach($courses_lessons as $courses_lesson)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="{{ route('edit_lesson',['lid'=>$courses_lesson->id]) }}">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        @if($courses_lesson->status == 0)
                                            <a href="{{ route('change_lesson_status',['lid'=>$courses_lesson->id,'status'=>'1']) }}" class="btn btn-success change_status" title="Activate" type="warning" msg="Are you sure you want to activate?">
                                                <i class="far fa-check-circle"></i>
                                            </a>
                                        @else
                                            <a href="{{ route('change_lesson_status',['lid'=>$courses_lesson->id,'status'=>'0']) }}" class="btn btn-warning change_status" title="DeActivate" type="warning" msg="Are you sure you want to DeActivate?">
                                                <i class="far fa-times-circle"></i>
                                            </a>
                                        @endif
                                        <a href="{{ route('change_lesson_status',['lid'=> $courses_lesson->id,'status'=>'2']) }}" class="btn btn-danger change_status" title="Delete" type="warning" msg="Are you sure to delete the course?"/>
